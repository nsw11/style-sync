          ...
          <>
            ...
            {currentSection >= 0 && (
              <div className="flex justify-center">
                <Button variant="ghost" onClick={nextSection} className="gap-2" disabled={currentSection >= 6}>
            ...
            {/* Section 7: AI Style Profile */}
            {currentSection >= 6 && (
              <Card className="bg-gradient-to-br from-[hsl(220,40%,20%)] to-[hsl(30,20%,25%)] border-0 text-white overflow-hidden">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <CardTitle className="flex items-center gap-2 text-xl font-serif text-white/90">
                      <Sparkles className="w-5 h-5 text-[hsl(35,40%,65%)]" />
                      Your Style Profile
                    </CardTitle>
                ...
                <CardContent className="space-y-4">
                  <p className="text-lg leading-relaxed font-serif text-white/90 italic">
                    "Your style is refined classic with a nostalgic edge. You've mastered the art of professional polish—crisp button-downs are your foundation, anchoring a wardrobe that balances workplace sophistication with subtle personal flair. There's a distinct 90s sensibility woven throughout your choices: clean lines, quality fabrics, and an understated confidence that doesn't need to shout. You understand that great style is about consistency and versatility, building a rotation of pieces that work hard and look sharp. Your approach is timeless—the kind of wardrobe that ages well and never looks dated."
                  </p>
                  <p className="text-xs text-white/50">
                    Generated by AI based on your wardrobe data
                  </p>
                </CardContent>
              </Card>
            )}
